                ...
                <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
                    <ul className="flex flex-col items-center font-medium gap-y-4 sm:flex-row sm:gap-x-8">
                        <li className="w-max h-max">
                            <a className="text-slate-800 hover:text-primary_theme flex items-center justify-center" href="#">Home</a></li>
                        <li className="w-max h-max">
                            <a className="text-slate-800 hover:text-primary_theme flex items-center justify-center" href="#">
                                Message</a></li>
                        <li className="w-max h-max">
                            <a className="text-slate-800 hover:text-primary_theme flex items-center justify-center" href="#">
                                Explore</a></li>
                        <li className="w-max h-max">
                            <a className="text-slate-800 hover:text-primary_theme flex items-center justify-center" href="#">
                                Profile</a></li>
                        <li className="w-max h-max">
                            <a className="text-slate-800 hover:text-primary_theme flex items-center justify-center" href="#">Create</a></li>
                        <li className="mt-2 sm:mt-0"><a className="rounded-xl border-2 border-primary_theme px-6 py-2 font-medium text-primary-theme hover:bg-primary_theme hover:text-white flex" href="#">Logout</a></li>
                    </ul>
                </nav>
            </div>
        </header>
