"""
Django settings for greenverse project.
...
SECRET_KEY = 'django-insecure-2)+3dcy!#dyij6(o$tgvar4vp-2!%!eg*u17qrh5&_h$b265t9'
...
WSGI_APPLICATION = 'greenverse.wsgi.application'
